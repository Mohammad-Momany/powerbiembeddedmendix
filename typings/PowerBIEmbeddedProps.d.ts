...
export interface PowerBIEmbeddedContainerProps {
    ...
    f1Enable: DynamicValue<boolean>;
    f1Table?: DynamicValue<string>;
    f1Column?: DynamicValue<string>;
    f1Value?: DynamicValue<string>;
    f1Operator: F1OperatorEnum;
    f1Locked: boolean;
    f1Hidden: boolean;
    f2Enable: DynamicValue<boolean>;
    f2Table?: DynamicValue<string>;
    f2Column?: DynamicValue<string>;
